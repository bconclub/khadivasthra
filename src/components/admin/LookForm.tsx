...
import { Upload, X, Loader2, Search, GripVertical, Plus, ChevronUp, ChevronDown } from "lucide-react";
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="border-t border-gray-100 dark:border-gray-700 pt-4">
        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
          Products in this look{" "}
          <span className="text-gray-400 font-normal">({productIds.length})</span>
        </label>
        <p className="text-xs text-gray-400 mb-2">
          Add the shirt, the mundu, the pair together, accessories — whatever a shopper should be
          able to buy from this look.
        </p>
